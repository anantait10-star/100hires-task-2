...
source: linkedin
post_url: https://www.linkedin.com/posts/armand-farrokh_conner-chesson-hit-200-of-sdr-quota-at-gong-activity-7459997205576392704-Nle4?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFqsGIIBquENv7QrqiROxZrt0_vYF-cwVXQ
date_collected: 2026-06-21
topic: objection_handling
pipeline_stage: cold_call_execution
framework: send_me_an_email
---
# Original Post
...
Keep knocking down those dials Conner.
...
"Send me an email" is often not a request for information, but a polite rejection pattern.

The framework prevents the conversation from ending immediately by acknowledging the request while testing whether there is genuine interest.
...
2. Incentivize
- Create a reason to continue talking

3. Test Drive
- Reframe the meeting as a low-risk evaluation

4. Permission
- Ask before challenging the objection

5. Disarmingly Blunt Question
...
Cold call → Objection → Recovery → Meeting conversion

## Potential playbook use

Build response scripts for common cold call objections.
